...
We use Eclipse but you can use any Maven and WebLogic capable IDE. We use Postgres but you can use any relational database such as Oracle or SQL Server.
